...
with open("fp_win_dqn_data.pkl", "wb") as outfile1:
    pickle.dump(trial_winners, outfile1)
with open("fp_reward_dqn_data.pkl", "wb") as outfile2:
    pickle.dump(trial_rewards, outfile2)
with open("fp_steps_dqn_data.pkl", "wb") as outfile3:
    pickle.dump(trial_steps, outfile3)
with open("fp_pairs_dqn_data.pkl", "wb") as outfile4:
    pickle.dump(trial_pairs, outfile4)
with open("fp_percent_win_data.pkl", "wb") as outfile5:
