...
ax1.set_title('Percent wins for DQN vs three random')
fig1.savefig('dqn_wins_4p.png')
...
fig2.savefig('dqn_coverage_4p.png')


with open("win_dqn_data_4p.pkl", "wb") as outfile1:
    pickle.dump(trial_winners, outfile1)
with open("reward_dqn_data_4p.pkl", "wb") as outfile2:
    pickle.dump(trial_rewards, outfile2)
with open("steps_dqn_data_4p.pkl", "wb") as outfile3:
    pickle.dump(trial_steps, outfile3)
with open("pairs_dqn_data_4p.pkl", "wb") as outfile4:
    pickle.dump(trial_pairs, outfile4)
with open("percent_win_data_4p.pkl", "wb") as outfile5:
